...
public class UserInterface
{
    ...
    public UserInterface ()
    {
        ...
        settings = new Settings ("org.tga.DocScan");
    ...
    public void help_contents_menuitem_activate_cb (Gtk.Widget widget)
    {
        try
        {
            Gtk.show_uri (window.get_screen (), "help:doc-scan", Gtk.get_current_event_time ());
        }
        catch (Error e)
        {
    ...
    public void about_menuitem_activate_cb (Gtk.Widget widget)
    {
        ...
        string description = _("Document scanning tool");
        ...
        Gtk.show_about_dialog (window,
                               ...
                               "copyright", _("Copyright © 2023 TGA"),
                               "license", license,
                               "wrap-license", true,
                               null);
    }
    ...
    [CCode (cname = "G_MODULE_EXPORT doc_scan_window_configure_event_cb", instance_pos = -1)]
    public bool doc_scan_window_configure_event_cb (Gtk.Widget widget, Gdk.EventConfigure event)
    {
    ...
    [CCode (cname = "G_MODULE_EXPORT doc_scan_window_window_state_event_cb", instance_pos = -1)]
    public bool doc_scan_window_window_state_event_cb (Gtk.Widget widget, Gdk.EventWindowState event)
    {
    ...
    private void load ()
    {
        ...
        var filename = Path.build_filename (UI_DIR, "doc-scan.ui", null);
        try
        {
        ...
        window = (Gtk.Window) builder.get_object ("doc_scan_window");
...
// FIXME: Duplicated from doc-scan.vala
