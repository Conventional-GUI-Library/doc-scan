...
{
    private static string AUTOSAVE_DIR = Path.build_filename (Environment.get_user_cache_dir (), "doc-scan", "autosaves");
    ...
    public void load ()
    {
        ...
        var pages = get_value (file, "doc-scan", "pages");
    ...
    private void real_save ()
    {
        ...
        file.set_value ("doc-scan", "pages", page_names);
